...
php7_install(){
	...
	echo -e "deb https://packages.sury.org/php/ $(lsb_release -sc) main" > /etc/apt/sources.list.d/php.list
	#install php7.0
...
*/5 * * * * /usr/bin/php /home/wwwroot/${domain}/one.php cache:refresh" > bt.cron
crontab bt.cron
rm -rf bt.cron
}
